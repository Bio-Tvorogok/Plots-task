    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->checkBoxDrag->setChecked(true);
...
{
    QMessageBox::about(this, "О программе", "Программа для работы с графиками\nс помощью библиотеки QCustomPlot\n\nВыполнил студент группы 8-Т3О-303Б\nКирдяшкин Игорь");
}
...
void MainWindow::on_ButtonSaveImg_clicked()
{
    adapter_->on_save();
}
...
{
    adapter_->set_axis_colored(checked);
}

void MainWindow::on_checkBoxDrag_clicked(bool checked)
{
    adapter_->switch_move(checked);
}
